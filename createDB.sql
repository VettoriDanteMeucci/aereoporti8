...
--
-- Crea il database `es_8_aeroporti` se non esiste già
--
CREATE DATABASE IF NOT EXISTS `aeroporti`;
USE `aeroporti`;
...
CREATE TABLE `compagnie` (
  `id_compagnia` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(50) NOT NULL,
...
CREATE TABLE `voli` (
  `id_volo` int(11) NOT NULL AUTO_INCREMENT,
